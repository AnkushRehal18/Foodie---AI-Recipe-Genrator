      ...
      <div className="max-w-6xl mx-auto">
        ...
        {recipeofTheDay && (
          <section className="mb-24 relative">
            ...
            >
              <div
                className="relative bg-white border-2 border-stone-900 overflow-hidden
                hover:shadow-lg transition-all duration-300 group cursor-pointer"
              >
                <div className="grid md:grid-cols-2 gap-0">
                  <div
                    className="relative aspect-[4/3] md:aspect-auto border-b-2
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      <Badge
                        variant="outline"
                        className="border-2 border-stone-900 text-stone-700 bg-stone-50 font-bold flex items-center"
                      >
        ...
        <section className="mb-24">
          <div className="mb-8">
            ...
            <p className="text-stone-600 text-lg font-light">
              Find recipes that match your favorite food.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {categories.map((category) => (
              ...
              >
                <div
                  className="bg-white p-6 border-2 border-stone-200
              ...
              .map((area) => (
                <Link
                  ...
                  href={`/recipes/cuisine/${area.strArea
                    ...
                    .replace(/\s+/g, "-")}`}
                >
                  <div className="bg-white p-5 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all duration-300 group cursor-pointer h-full">
