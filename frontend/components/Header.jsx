                    ...
                    <Show when="signed-in">
                        ...
                        {user && <PricingModal
                            ...
                            <Badge variant='outline'
                                className={`flex px-3 gap-1.5 rounded-full text-xs font-semibold transition-all
                                ${user.subscriptionTier === "pro"
                                        ? "bg-linear-to-r from-orange-600 to-amber-500 text-white border-none shadow-sm"
                                        : "bg-stone-200/500 text-stone-600 border-stone-200 cursor-pointer hover:bg-stone-300/500 hover:border-stone-300"
                                    }`}
                            >
                                <Sparkles
